...
from core.account.use_cases.delete_account import DeleteAccount
...
class AccountFactory:
    ...
    @classmethod
    def make_delete_account(cls) -> DeleteAccount:
        return DeleteAccount(account_repository=cls.make_account_repository())
